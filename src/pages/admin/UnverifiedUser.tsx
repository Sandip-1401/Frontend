...
import { unverifieduser } from "@/features/general/api"
...
import { ArrowDownUp, ArrowUpDown,  SearchIcon, XOctagonIcon } from "lucide-react"
import { Button } from "@/components/ui/button"
import { useEffect, useState } from "react"
import { unverifiedUser } from "./UnverifiedHeader"
...
const UnverifiedUser = () => {
   ...
   const { data, isLoading, error } = useQuery<User[]>({
      queryKey: ["Users", debouncedSearch, sort, order],
      queryFn: async () => {
         const res = await unverifieduser(debouncedSearch, sort, order);
