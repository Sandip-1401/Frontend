...
import { deleteDoctorById, getDoctorById } from "@/features/general/api";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { MapPin, Mail, Phone, ShieldCheck, MailIcon, Stethoscope, Building2, IndianRupee, Clock, X } from "lucide-react";
...
const ViewDoctor = () => {
   ...
   const {data, isLoading, error} = useQuery<Doctor>({
      queryKey: ["patient"],
      queryFn: async () => {
         const res = await getDoctorById(String(doctorId));
   ...
   const handleDeletion = () => {
      deleteMutation.mutate(String(doctorId)),
