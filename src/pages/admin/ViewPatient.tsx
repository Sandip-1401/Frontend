...
import { deletePatientById, getPatientById } from "@/features/general/api";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { Droplets, MapPin, Ruler, Weight, User, Mail, Phone, ShieldCheck, MailIcon, X } from "lucide-react";
...
import type { Patient } from '@/types/apiResponse';
...
const ViewPatient = () => {
   ...
   const {data, isLoading, error} = useQuery<Patient>({
      queryKey: ["patient"],
      queryFn: async () => {
         const res = await getPatientById(String(patientId));
   ...
   const handleDeletion = () => {
      deleteMutation.mutate(String(patientId)),
    ...
    <div className="p-4">
      ...
      <div className="p-2">
        <div className=" flex items-center ">
          <h1 className="text-3xl font-bold text-primary ml-4"></h1>
          <Button className="ml-auto py-4 bg-red-500 hover:bg-red-600" 
