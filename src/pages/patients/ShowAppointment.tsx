...
import { Calendar, CheckCircle, Clock, Heart, Pen, Phone, Ruler, User2, Weight} from 'lucide-react'
      ...
      <div className='sm:px-5 mt-5'>
        <Tabs defaultValue="appointment" className="sm:w-full flex flex-col">
          <TabsList className="sm:w-[70%] md:w-[50%] sm:h-10 items-center justify-start border sm:rounded-lg bg-transparent sm:p-0 w-full sm:gap-8 text-sm overflow-x-scroll rounded-lg sm:overflow-hidden scrollbar-hide dark:border-gray-200/40">
            ...
            <TabsTrigger value="doctor" className="sm:rounded-lg rounded-lg font-semibold text-sm shadow-none data-[state=active]:bg-primary data-[state=active]:text-white dark:text-gray-200 dark:hover:text-gray-100 p-1">
              Doctor Info
            </TabsTrigger>
          </TabsList>
            ...
            <Card className='p-2 dark:border-gray-200/40 dark:border dark:gap-0'>
              ...
              <div className='flex items-center gap-3 p-3 border-b dark:border-gray-500'>
                <div className='w-12 h-12 rounded-full bg-cyan-500 flex items-center justify-center text-white font-semibold text-lg'>
                  {data?.doctor.user.name.split(' ').map(n => n[0]).join('')}
                </div>
                <div>
                  <p className='font-semibold text-gray-800 dark:text-white text-sm'>{data?.doctor.user.name}</p>
                  <p className='text-xs text-gray-500 dark:text-gray-400'>{data?.doctor.user.email}</p>
                </div>
              </div>
              ...
              <div className='sm:grid sm:grid-cols-2 md:grid-cols-3 gap-2'>
                ...
                <Card className='p-3 grid grid-cols-3 grid-rows-2 gap-0 place-items-center dark:border-b dark:rounded-none dark:border-gray-500 dark:py-6'>
                  ...
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white'>{data?.doctor.user.phone_number}</p>
                </Card>
                ...
                <Card className='p-3 grid grid-cols-3 grid-rows-2 gap-0 place-items-center dark:border-b dark:rounded-none dark:border-gray-500 dark:py-6'>
                  ...
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white leading-tight'>QUALIFICATION</p>
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white'>{data?.doctor.qualification}</p>
                </Card>

                <Card className='p-3 grid grid-cols-3 grid-rows-2 gap-0 place-items-center dark:border-b dark:rounded-none dark:border-gray-500 dark:py-6'>
                  <Heart className='col-span-1 row-span-2 bg-cyan-500 w-12 h-12 p-2 rounded-xl text-white' size={18} />
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white leading-tight'>CONSULTATION</p>
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white'>${data?.doctor.consultation_fee}</p>
                </Card>

                <Card className='p-3 grid grid-cols-3 grid-rows-2 gap-0 place-items-center dark:border-b dark:rounded-none dark:border-gray-500 dark:py-6'>
                  <Ruler className='col-span-1 row-span-2 bg-cyan-500 w-12 h-12 p-2 rounded-xl text-white' size={18} />
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white leading-tight'>DEPARTMENT</p>
                  {/* <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white'>{data?.doctor.department} cm</p> */}
                </Card>

                <Card className='p-3 grid grid-cols-3 grid-rows-2 gap-0 place-items-center dark:border-b dark:rounded-none dark:border-gray-500 dark:py-6'>
                  <Weight className='col-span-1 row-span-2 bg-cyan-500 w-12 h-12 p-2 rounded-xl text-white' size={18} />
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white leading-tight'>EXPERIENCE</p>
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-gray-800 dark:text-white'>{data?.doctor.experience_years}Years</p>
                </Card>
                ...
                <Card className='p-3 grid grid-cols-3 grid-rows-2 gap-0 place-items-center dark:rounded-none dark:py-6'>
                  ...
                  <p className='col-span-2 row-span-1 text-sm font-semibold text-green-600'>{data?.doctor.status}</p>
                </Card>
